...
public class MasterServerRunnable implements
		ServerTestRunnerAwareRunnable<AccumuloMasterRunner> {
	...
	public MasterServerRunnable(String hostname, File baseDirectory,
			List<String> classpath, boolean quiet) {
		super();
	...
	public void run() {
		try {
			...
			masterServer = new AccumuloMasterRunner(hostname, baseDirectory,
					classpath);
